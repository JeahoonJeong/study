	...
	<form action="" name="myForm" method="post">
		<table width="500" align="center" cellpadding="0" cellspacing="0">
			...
			<tr height="30">
				...
				<td style="padding-left: 5px"><%=dto.getHak() %>
			...
			<tr height="30">
				...
				<td style="padding-left: 5px"><%=dto.getName() %> </td>
			</tr>
			...
			<tr height="30">
				...
				<td style="padding-left: 5px">
					<input type="text" name="kor" size="20" maxlength="3" class="txtField" value="<%=dto.getKor() %>"/>
				</td>
			</tr>
			...
			<tr height="30">
				...
				<td style="padding-left: 5px">
					<input type="text" name="eng" size="20" maxlength="3" class="txtField" value="<%=dto.getEng() %>"/>
				</td>
			</tr>
			...
			<tr height="30">
				...
				<td style="padding-left: 5px">
					<input type="text" name="mat" size="20" maxlength="3" class="txtField" value="<%=dto.getMat() %>"/>
				</td>
			</tr>
