...
<table width="700" cellpadding="0" cellspacing="3" align="center" bgcolor="#e4e4e4">
	<tr>
		<td bgcolor="#ffffff" style="padding-left: 10px"><b>성적처리 리스트</b></td>
	</tr>
</table>
<br/>
...
<table width="560" cellpadding="0" cellspacing="3" align="center" bgcolor="#cccccc">
	<tr height="30">
	...
	<tr height="30">
		...
		<td align="center" bgcolor="#ffffff">
			<a href="update.do?hak=${dto.hak }&pageNum=${pageNum}">수정</a> 
			<a href="delete_ok.do?hak=${dto.hak }&pageNum=${pageNum}">삭제</a>
		</td>
	</tr>
	</c:forEach>
