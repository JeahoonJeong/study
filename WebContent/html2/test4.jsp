	...
	function poll(){
		...
		for(var i =0; i<clength;i++){
			...
			if(document.myForm2.r1[i].checked){
				alert(document.myForm2.r1[i].value + "가 가장 좋음!");
				return;
			}
...
<body>
	...
	<img alt="" src="../image/13798939c.jpg" width="80" height="80"  
		border="1" style="cursor: hand" onmouseover="fImg('../image/13798939c.jpg')" >
	
	<img alt="" src="../image/13798939e.jpg" width="80" height="80"  
		border="1" style="cursor: hand" onmouseover="fImg('../image/13798939e.jpg')" >
		
	<img alt="" src="../image/13798939f.jpg" width="80" height="80"  
		border="1" style="cursor: hand" onmouseover="fImg(this.src)" ><br/>
	...
	<form action="" name="myForm2">
		...
		<img alt="" src="../image/icon_poll_q.gif">
		<b>가장 좋아하는 연예인</b>
		<br/><br/>
		...
		<a href="javascript:poll();">
			<img alt="" src="../image/btn_poll01.gif" border="0">
		</a>
	</form>
