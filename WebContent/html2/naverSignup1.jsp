...
<table border="0" cellspacing="0"  align="center" class="mainTable">
	...
	<tr>
		...
		<td class="rightCol">
				<input type="text" name="userName" class="fiverow">
	...
	<tr>
		...
		<td class="rightCol">
			<input type="text" name="userId" class="fiverow"><font>@naver.com</font>
			<!--아이디 중복체크 -->
	...
	<tr>
		...
		<td class="rightCol">
			<input type="text"  class="fiverow" name="userPW1"> <a href="www.naver.com"><font size="2pt" color="#173664">비밀번호 도움말</font></a>
		</td>
	</tr>
			...
			<table class="password" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td class="row1" >
						...
						<select class="select1" name="question">
				...
				<tr>
					<td class="row1">
						...
						<input type="text" class="answer1" name="answer1">
					</td>
				</tr>
