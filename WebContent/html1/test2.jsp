...
<table border="1" width ="60%" height="200" align="center" cellpadding="0" cellspacing="0">
...
<table background="../image/bg_575x84.gif" width="575" height="84">
	...
	<tr>
		<td align="center">
			...
			<tr>
				<td>
					<input type="text"style="width: 300; height: 22;">
					<img src="../image/btn_search.gif" align="top"/>
				</td>
			</tr>
			<tr>
				<td align="center">
				<input type="radio" name="r1"/><b>카페명</b>
				<input type="radio" name="r1"/><b>게시물</b>
				<input type="radio" name="r1"/><b>메니져</b>
				</td>
			</tr>			
			</table>
		</td>
