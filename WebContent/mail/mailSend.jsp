...
<form action="mailSend_ok.jsp" name="myForm" method="post" enctype="multipart/form-data" >
	<table width="600" border="0" cellpadding="0" cellspacing="3"  align="center">
		...
		<tr>
			<td colspan="2" height="3" bgcolor="#dbdbdb" align="left"></td>
		</tr>
		<tr>
			<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px">보내는 사람 이름</td>
		...
		<tr>
			<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px">보내는 사람 Email</td>
			<td width="460" style="padding-left:  10px">
		...
		<tr>
			<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px">받는 사람 Email</td>
			<td width="460" style="padding-left:  10px">
		...
		<tr>
			<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px">제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
			<td width="460" style="padding-left:  10px">
		...
		<tr>
			<td width="140" height="30" bgcolor="#eeeeee" style="padding-left: 20px">내&nbsp;&nbsp;&nbsp;&nbsp;용</td>
			<td width="460" style="padding-left:  10px">
	...
	<table width="600" border="0" cellpadding="3" cellspacing="0" align="center">
		<tr align="center">
			<td height="40">
				...
				<input type="reset" value="다시입력" class="btn2" onclick="document.myForm.sendMail.focus();">
			</td>
		</tr>
	</table>
